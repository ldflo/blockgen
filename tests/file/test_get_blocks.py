...
class Test:
    ...
    def test_1(self):
        with tempfile.TemporaryDirectory() as dir:
            ...
            blocks = blockgen.file.get_blocks(filepath)
    ...
    def test_2(self):
        with tempfile.TemporaryDirectory() as dir:
            ...
            blocks = blockgen.file.get_blocks(filepath, encoding="utf_7")
            assert blocks == {"block1": "\xc3"}
...
class Test_ErrorCases:
    ...
    def test_1(self):
        with tempfile.TemporaryDirectory() as dir:
            ...
            try:
                blockgen.file.get_blocks(filepath)
                assert False
