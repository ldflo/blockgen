...
class Test:
    ...
    def test_1(self):
        with tempfile.TemporaryDirectory() as dir:
            ...
            with contextlib.redirect_stdout(io.StringIO()) as stdout:
                result = blockgen.file.replace_blocks(filepath, blocks)
            assert result == """
                <<[ block1 ]>>
                tuvw
                <<[ end ]>>
    ...
    def test_2(self):
        with tempfile.TemporaryDirectory() as dir:
            ...
            blocks = {"block1": "\xc3"}
            with contextlib.redirect_stdout(io.StringIO()) as stdout:
                result = blockgen.file.replace_blocks(filepath, blocks, encoding="utf_7")
            assert result == """
                <<[ block1 ]>>
                \xc3
                <<[ end ]>>
    ...
    def test_3(self):
        with tempfile.TemporaryDirectory() as dir:
            ...
            blocks = {"block1": "tuvw"}
            with contextlib.redirect_stdout(io.StringIO()) as stdout:
                result = blockgen.file.replace_blocks(filepath, blocks, newline="\r\n")
            assert result == """
                <<[ block1 ]>>
                tuvw
                <<[ end ]>>
...
class Test_ErrorCases:
    ...
    def test_1(self):
        with tempfile.TemporaryDirectory() as dir:
            ...
            try:
                blocks = {"block1": "tuvw"}
                blockgen.file.replace_blocks(filepath, blocks)
                assert False
    ...
    def test_4(self):
        try:
            ...
            with tempfile.TemporaryDirectory() as dir:
                ...
                blocks = {"block2": "xyz"}
                new_text = blockgen.file.replace_blocks(filepath, blocks)
