...
class Test_Inline:
    ...
    class Test_Inline_NominalCases:
        ...
        def test_7(self):
            ...
            blocks = blockgen.string.get_blocks(text)
            assert blocks == {"block1": "abc", "block2": "def"}
        ...
        def test_44(self):
            ...
            blocks = blockgen.string.get_blocks(text)
            assert blocks == {"block1('string', 1, 1.0, ['a', 'b', 'c'])": "abc"}
        ...
        def test_47(self):
            ...
            blocks = blockgen.string.get_blocks(text)
            assert blocks == {"block1('string', 1, 1.0, ['a', [1, 2, 3], 'c'])": "abc"}

        def test_48(self):
            # Block with Python parameters
            text = """<<[ block1("string", 1, 1.0000, ['a', [1, 2, 3], {'a': 1, 'b': 2}]) ]>> abc <<[ end ]>>"""
            blocks = blockgen.string.get_blocks(text)
            assert blocks == {"block1('string', 1, 1.0, ['a', [1, 2, 3], {'a': 1, 'b': 2}])": 'abc'}
...
class Test_Multiline:
    ...
    class Test_Multiline_NominalCases:
        ...
        def test_40(self):
            ...
            """
            blocks = blockgen.string.get_blocks(text)
            assert blocks == {"block1(1, 2)": "abc", "block2('1', '2')": "def"}
        ...
        def test_41(self):
            ...
            """
            blocks = blockgen.string.get_blocks(text)
            assert blocks == {"block1(1, p2=2)": "abc", "block2('1', '2')": "def"}
        ...
        def test_55(self):
            ...
            """
            blocks = blockgen.string.get_blocks(text)
            assert blocks == {"block1": "abc", "block2": "def", "block3": "ghi"}
